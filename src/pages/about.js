...
const AboutMePage = () => {
  return (
    <>
      <Seo title="About Me" />
      <main className="--body3 py-12 px-5 md:px-24 font-serif">
        <Masthead />
        ...
        <div className="prose max-w-full xl:w-3/4 xl:float-left">
          ...
          >
            ...
            <p className={paragraphStyle}>
              I am a front-end & integration developer.
            </p>
          ...
          >
            ...
            <p className={paragraphStyle}>
              ...
              graphics. Please see the README and LICENSE files for more
              information.
            </p>
          </div>
        </div>
