        ...
        <div className="prose max-w-full xl:w-2/3 xl:float-left">
          ...
          >
            ...
            <p className={paragraphStyle}>
              ...
              regions, and a couple of hundred products that needed to follow a
              defined category hierarchy.
            </p>
            <p className={paragraphStyle}>
              Additional supporting sites were built; one to allow customers to
              login and view their loyalty points and another to manage said
              customer accounts.
            </p>
          </div>
          {/* Mission brief ends */}
          ...
          >
            ...
            <p className={paragraphStyle}>
              The website was originally built atop Textpattern&mdash;a somewhat
              obsolete PHP-based CMS&mdash; and its version of PHP had long been
              deprecated by their hosting provider. The site design was not
              responsive and the content management and multilingual support was
              not easily scalable. Attempts to upgrade the CMS and PHP to
              current versions brought errors and would have necessitated PHP
              expertise that was outside my wheelhouse. The site was also hosted
              on a shared virtual server which I suspected would have to be
              upgraded or migrated to handle the additional traffic the client
              envisioned.
            </p>
            <h3 className="underline text-xl">Solution</h3>
            <p className={paragraphStyle}>
              I wanted the site to take a serverless approach and propagate to a
              CDN rather than reside on a single server. I also wanted to plan
              the architecture and devops to be easier to manage and integrate.
              Using third-party resources and API (PaaS) would allow the site to
              better handle long-term growth of both content and audience.
            </p>
            <p className={paragraphStyle}>
              I proposed a{' '}
              <a
              ...
              solution and provided estimates of monthly operating costs to the
              client who gave their blessing to proceed and begin anew. One
              advantage to using PaaS is being able to better judge costs than
              estimating that associated with writing all the functionality from
              scratch or with integrating an expensive enterprise software that
              has very narrow platform requirements and admin-level access.
            </p>
            <p className={paragraphStyle}>
              ...
              deployed on Netlify's CDN using their CI pipeline with the
              project's Git repository. The website data and content were set up
              in GraphCMS and mapped into the front-end components and templates
              GraphQL. Algolia was integrated to provide Search functionality.
              In addition, a couple of server-side utilities were needed for
              form submission and product synchronization with Algolia so they
              were created using Netlify's Amazon Lambda implementation. Last
              but not least, taking advantage of Slack's webhooks allowed us to
              trigger builds (dev or production) with keywords in our team chat,
              avoiding the need for any admin dashboards or devops knowledge for
              the folks needing site rebuilds.
            </p>
            <p className={paragraphStyle}>
              ...
              manage membership data and Auth0 was integrated to manage sign-ups
              and authentication.
            </p>
            <p className={paragraphStyle}>
              ...
              times. Nonetheless, the interconnectedness of all the services and
              components is testament to how far web production has come to
              enabling small teams&mdash;or even one person&mdash;to accomplish
